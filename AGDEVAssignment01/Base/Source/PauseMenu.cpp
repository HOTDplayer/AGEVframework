...
void PauseMenu::Update(double dt)
{
	...
	if (KeyboardController::GetInstance()->IsKeyPressed('P') && canpause == true)
	{
		pause = !pause; // Toggle between true and false
		canpause = false;
...
void PauseMenu::Render()
{
	...
	//GraphicsManager::GetInstance()->UpdtaeLightUniforms();
